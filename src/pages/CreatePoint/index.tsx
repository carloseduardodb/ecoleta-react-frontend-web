...
const CreatePoint = () => {
    ...
    const [markers, setMarkers] = useState<[number, number]>([0, 0]);
    ...
    // Puxa dados da cidade de acordo com estado
    useEffect(() => {
        if (selectedUf === '0') {
            return;
        }
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <MapContainer
                        center={InitialPosition[0] === 0 ? [-21.2355116, -45.7614559] : InitialPosition}
                        zoom={15}
                    >
                        <TileLayer
